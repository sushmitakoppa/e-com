    ...
    <v-container>
      <div class="row">
        ...
        >
          ...
          <div class="row text-center" v-if="ProductsData.length>0">
            <div class="col-md-3 col-sm-6 col-xs-12" :key="Product._id" v-for="Product in ProductsData">
              ...
              <v-hover v-slot:default="{ hover }">
                ...
                >
                  ...
                  >
                    <v-card-title>{{Product.product_type}} </v-card-title>
                    <v-expand-transition>
                      <div
                        v-if="hover"
                        ...
                        style="height: 100%;"
                      >
                        <v-btn v-if="hover" :href="`/product/`+Product._id" class="" outlined>VIEW</v-btn>
                      </div>
            ...
            products:[
                {
                    ...
                    type:'Jackets',
                    price:'18.00',
                    src:'https://cdn.shopclues.com/images1/thumbnails/115246/200/200/152689876-115246212-1631016838.jpg'
                },
                {
                    id:2,
                    name:'WHITE TEE',
